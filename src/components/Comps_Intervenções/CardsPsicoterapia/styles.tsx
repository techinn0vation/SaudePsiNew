...
export const WrapperPsicoterapia = styled.section`
  width: 100%;
  min-height: auto;
...
`
export const ContentPsicoterapia = styled.main`
  width: 100%;
  min-height: auto;
  ...
  align-items: center;
`
export const ViewPsicoterapia = styled.div`
  width: 100%;
  min-height: auto;
  ...
  & > div:nth-child(1) {
    ...
    h1 {
      ...
      &::after {
        content: 'Intervenções em Psicoterapia';
...
`
export const WrapperCardsPsicoterapia = styled.div`
  width: 100%;
  overflow: hidden;
  height: 140rem;
  padding: 1.4rem;
...
`
export const HeadCardPsicoterapia = styled.div`
  width: 100%;
  height: 18rem;
...
`
export const InnerHeadCardPsicoterapia = styled.div`
  width: auto;
